...
function getSubPageContent(name) {
  ...
  var content = {
    'rosary': '<img class="sp-hero" src="'+imgMap['rosary_stock']+'" alt="Rosary" loading="lazy">' +
      ...
      '<button class="sp-btn" onclick="showVideoPlayer(\'Rosary for Children\',\'cq8izSEtKsc\')"><svg viewBox="0 0 24 24" width="20" height="20" style="fill:var(--teal)"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg> Rosary for Children</button></div>' +
    ...
    'mass': '<img class="sp-hero" src="'+imgMap['mass_01']+'" alt="Mass" loading="lazy">' +
      ...
      '<button class="sp-btn" onclick="showVideoPlayer(\'Stations of the Cross\',\'pJNjtA-Awb4\')"><svg viewBox="0 0 24 24" width="20" height="20" style="fill:var(--coral)"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/></svg> Stations of the Cross</button>' +
    ...
    'kids-rosary': '<img class="sp-hero" src="'+imgMap['children_rosary_2']+'" alt="Kids Rosary" loading="lazy">' +
      ...
      '<button class="sp-btn primary" onclick="showVideoPlayer(\'Rosary for Children\',\'cq8izSEtKsc\')"><svg viewBox="0 0 24 24" width="20" height="20"><path d="M8 5v14l11-7z"/></svg> Watch the Children\'s Rosary</button>' +
    ...
    'chaplet-mercy': '<div class="sp-section"><h3>Chaplet of Divine Mercy</h3><p>Given by Jesus to St. Faustina, this powerful prayer is prayed on ordinary rosary beads. Pray at 3:00 PM, the hour of mercy.</p></div>' +
      '<button class="sp-btn primary" onclick="showVideoPlayer(\'Divine Mercy Chaplet\',\'RHTVPnIKXT8\')"><svg viewBox="0 0 24 24" width="20" height="20"><path d="M8 5v14l11-7z"/></svg> Pray the Chaplet <span class="sp-btn-right"><span class="live-dot"></span> praying</span></button>' +
    ...
    'stations': '<div class="sp-section"><h3>Stations of the Cross</h3><p>Walk with Jesus on His journey to Calvary through these 14 stations of prayer and reflection.</p></div>' +
      '<button class="sp-btn primary" onclick="showVideoPlayer(\'Stations of the Cross\',\'pJNjtA-Awb4\')"><svg viewBox="0 0 24 24" width="20" height="20"><path d="M8 5v14l11-7z"/></svg> Pray the Stations</button>' +
    ...
    'novenas': '<div class="sp-section"><h3>Novenas</h3><p>Nine days of focused prayer for special intentions. Choose a novena to begin your journey of faith.</p></div>' +
      '<div class="course-card"><h4>Novena to the Sacred Heart</h4><div class="cc-lessons">9 days</div><p>Pray to the Sacred Heart of Jesus for healing, protection, and love. One of the most powerful devotions.</p><button class="cc-start" onclick="showVideoPlayer(\'Sacred Heart Novena\',\'KUIGnujimwQ\')">Begin</button></div>' +
      '<div class="course-card"><h4>Novena to St. Jude</h4><div class="cc-lessons">9 days</div><p>The patron saint of hopeless cases and desperate situations. Pray for impossible intentions.</p><button class="cc-start" onclick="showVideoPlayer(\'St Jude Novena\',\'nz_t3FSbVkw\')">Begin</button></div>' +
